...
yy_prof_adapter_define_list[] =
{
    ...
    {"PDO::prepare"                    , ADAPTER_TYPE_EQUALS, 1, yy_prof__sql_func},
    ...
    {"mysqli::prepare"                 , ADAPTER_TYPE_EQUALS, 1, yy_prof__sql_func},
    ...
    {"mysqli_prepare"                  , ADAPTER_TYPE_EQUALS, 1, yy_prof__sql_func},
